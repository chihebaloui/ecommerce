    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
        <?php if (isset($_GET['ajout']) && $_GET['ajout']== "ok"){
            ...
            categorie ajouter avec succes </div>
';
            }
            
            if (isset($_GET['delete']) && $_GET['delete']== "ok"){
              print' <div class="alert alert-success">
              categorie supprimer avec succes </div>
          ';
              }
              if (isset($_GET['modif']) && $_GET['modif']== "ok"){
                print' <div class="alert alert-success">
                categorie modifier avec succes </div>
            ';
                }
  ...
  <tbody>
    <?php
    $i=0;
     foreach($categories as $c)// boucler
      {
        $i++;
        print'<tr>
        <th scope="row">'.$i.'</th>
        ...
        <td>
         ...
         <a onclick="return popUp()" href="supprimer.php?idc='.$c['id'].'" class="btn btn-danger">Supprimer </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="ajout.php" method="POST">
            ...
            <div class ="form-group">
             <textarea  name="description"class="form-control" placeholder="description de categories ..."></textarea>
            </div>
      </div>
...
<?php
foreach($categories as $index=> $categories) // index boucle i
{
  ?>
      ...
      <div class="modal-body">
        <form action="modifier.php" method="POST">
          <input type="hidden" value="<?php echo $categories['id'];?> " name="idc"/>
            <div class ="form-group">
             <input type="text" name="nom"class="form-control"  value="<?php echo $categories['nom'] ?>" placeholder="nom de categories ...">
            </div>
            <div class ="form-group">
             <textarea  name="description"class="form-control" placeholder="description de categories ..."><?php echo $categories['description'] ?></textarea>
            </div>
      </div>
      <div class="modal-footer">
