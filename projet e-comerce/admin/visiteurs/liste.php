...
<div class="container-fluid">
  ...
  <tbody>
    <?php
     ...
     foreach($visiteurs as $i =>$visiteurs)// boucler
      {
        $i++;
        print'<tr>
        <th scope="row">'.$i.'</th>
        <td>'.$visiteurs['nom'].' '.$visiteurs['prenom'].'</td>
        <td>'.$visiteurs['email'].'</td>
        <td>
         <a  href="valider.php?id='.$visiteurs['id'].'" class="btn btn-success"  >valider</a>
